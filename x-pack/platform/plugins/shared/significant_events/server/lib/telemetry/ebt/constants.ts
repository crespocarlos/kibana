...
const SIGNIFICANT_EVENTS_AGENT_TOOL_EVENT_WRITE_EVENT_TYPE =
  'significant-events-agent-tool-event-write';
const SIGNIFICANT_EVENTS_AGENT_TOOL_DISCOVERY_WRITE_EVENT_TYPE =
  'significant-events-agent-tool-discovery-write';
